package top.b0x0.demo.infrastructure.pdf.util;
 ...
 * @author TANG
 */
public class PdfKeywordFinderUtils {

    public static void main(String[] args) throws IOException {

        String keyword = "甲方签字:";
        String templatePath = "D:\\code-demo\\pdf-demo\\src\\main\\resources\\templates\\template.pdf";

        List<float[]> positions = findKeywordPostions(templatePath, keyword);
    ...
    /**
     * 查找插入签名图片的最终位置，因为是插入签名图片，所以之前的关键字应只会出现一次
    ...
    public static float[] getAddImagePositionXY(String pdfName, String keyword) throws IOException {
        ...
        List<float[]> positions = PdfKeywordFinderUtils.findKeywordPostions(pdfName, keyword);
