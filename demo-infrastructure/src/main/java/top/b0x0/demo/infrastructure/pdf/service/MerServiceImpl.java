...
import top.b0x0.demo.infrastructure.pdf.entity.MerchantsDetail;
import top.b0x0.demo.infrastructure.pdf.entity.TemplateDataModel;
import top.b0x0.demo.infrastructure.pdf.util.MyBeanUtils;
import top.b0x0.demo.infrastructure.pdf.util.PdfTemplateUtils;
...
public class MerServiceImpl implements IMerService {
    ...
    @Override
    public List<String> entryPdfUpload2(String merId, top.b0x0.demo.infrastructure.infrastructure.pdf.util.PdfTemplateDataProperties pdfTemplateDataProperties) {
        List<TemplateDataModel> list = new ArrayList<>();
        // 模拟数据查询
        MerchantsDetail detail = this.findByMerId(merId);
        // 获取模板初始list
