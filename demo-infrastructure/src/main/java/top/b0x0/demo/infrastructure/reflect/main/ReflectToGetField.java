package top.b0x0.demo.infrastructure.infrastructure.reflect.main;

import top.b0x0.demo.infrastructure.reflect.domain.Student;
...
public class ReflectToGetField {
    public static void main(String[] args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException, ClassNotFoundException, NoSuchFieldException {
        ...
        //1.获取Class对象
        Class stuClass = Class.forName("top.b0x0.demo.infrastructure.reflect.domain.Student");
